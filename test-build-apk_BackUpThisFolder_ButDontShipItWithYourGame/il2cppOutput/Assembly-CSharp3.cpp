...
IL_01ce:
	{
		...
		float L_107;
		L_107 = Mathf_Max_mA9DCA91E87D6D27034F56ABA52606A9090406016_inline(L_106, (0.0f), NULL);
		Vector4_t58B63D32F48C0DBF50DE2C60794C4676C80EDBE3 L_108;
		memset((&L_108), 0, sizeof(L_108));
		...
		int32_t L_109;
		L_109 = RenderSettings_get_fogMode_mAE7F2FC731619C46CF1D5B52FA146D5BE850AC9C(NULL);
		V_17 = L_109;
		// var sceneDensity= RenderSettings.fogDensity;
		float L_110;
		L_110 = RenderSettings_get_fogDensity_mDDC77B6546D71C7CA79832D8BF1565EDE5B4617E(NULL);
		V_18 = L_110;
		// var sceneStart= RenderSettings.fogStartDistance;
		float L_111;
		L_111 = RenderSettings_get_fogStartDistance_mD870DC54F7E16D93223F4A8646B56ADF1679DC88(NULL);
		V_19 = L_111;
		// var sceneEnd= RenderSettings.fogEndDistance;
		float L_112;
		L_112 = RenderSettings_get_fogEndDistance_m88656D4121A7B38157BC123E9E8B5D886A6003AD(NULL);
		V_20 = L_112;
...
IL_0360:
	{
		...
		int32_t L_139 = V_25;
		GlobalFog_CustomGraphicsBlit_m676221CC6F5EDE8A39339A93DF7209379DEE451A(L_136, L_137, L_138, L_139, NULL);
		// }
		return;
	}
}
